...
<head>
    ...
    <title>Preprossesing Data Testing</title>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.php">Preprossesing Data Testing</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="data_testing.php">Data Testing</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h3>Proses Preprossesing Data</h3>
                    </div>
                <br>
                <br>
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    	<?php
							...
							$query = mysqli_query($conn, "SELECT * FROM data_testing");

							while($row = mysqli_fetch_array($query)){
								$cerita = $row['data_testing'];
								print("<hr /> Blurb asli: <br /> ". $cerita);
								...
								echo "<br />Setelah Filtering: <br />";
								print_r(array_values($cerita));

								//proses stemming
								echo"<br />Setelah Stemming Nazief & Adriani: <br />";
								foreach ($cerita as $value) {
									$stemming = stemming($value); //memanggil fungsi stemming() 
									print(" ".$stemming);
								}
							}
