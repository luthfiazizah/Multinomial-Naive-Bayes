        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.php">DF Thresholding</a>
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                while ($c = mysqli_fetch_array($data)) {
                                    ...
                                    print ("<br ><h2><b>Tabel TF IDF</b></h2><hr />");
                                    echo "<br>Jumlah Data: " . sizeof($doc);
                                    echo "<br>Jumlah Term: " . jumlahData($tabel);
                                    echo "<br><h5>Reduksi Fitur dalam penelitian ini menggunakan DF Thresholding dengan nilai threshold 2 - 15</h5>";
                                    echo "<br>";
                                    printTabel($tabel);
