        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="k101.php">Without</a></li>
                                  <li><a class="dropdown-item" href="k102.php">With</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Uji Coba K = 10</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" name="input" method="POST" action="#">
