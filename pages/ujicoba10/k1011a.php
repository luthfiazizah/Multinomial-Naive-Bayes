            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <br>
                                ...
                                $data = mysqli_query($conn,"SELECT * FROM data_cerita WHERE id_cerita NOT IN (4,5,6,30,31,32,56,57,58,81,82,107,108)");
                                ...
                                <div class="tab-content" id="myTabContent7">
                                    ...
                                    <div class="tab-pane fade" id="about-justify" role="tabpanel" aria-labelledby="profile-tab-justify">
                                        ...
                                        echo "<br>Prior Probabilitas P(humor) = " . round(23/117,3);
                                        echo "<br>Prior Probabilitas P(horor) = " . round(23/117,3);
                                        echo "<br>Prior Probabilitas P(roman) = " . round(23/117,3);
                                        echo "<br>Prior Probabilitas P(misteri) = " . round(24/117,3);
                                        echo "<br>Prior Probabilitas P(spiritual) = " . round(24/117,3);
                                        ...
                                        $humor = Phumor($table)*(23/117);
                                        $horor = Phoror($table)*(23/117);
                                        $roman = Proman($table)*(23/117);
                                        $misteri = Pmisteri($table)*(24/117);
                                        $spiritual = Pspiritual($table)*(24/117);
