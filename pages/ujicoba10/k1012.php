        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Uji Coba K = 10 Without DF Thresholding Percobaan ke-3</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" name="input" method="POST" action="k1012a.php">
