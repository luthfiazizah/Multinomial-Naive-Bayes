    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.php">Preprossesing</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="prepross.php"><i class="fab fa-fw fa-wpforms"></i>Preprossesing</a>
                            </li>
                            <li class="nav-item ">
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h3>Preprossesing Data</h3>
                        <a class="btn btn-primary" href="preprossesing.php" role="button">Lihat Proses</a>
                        <br>
                        <br>
                    </div>
                <br>
