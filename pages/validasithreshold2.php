                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="validasi.php">Without</a></li>
                          <li><a class="dropdown-item" href="validasithreshold.php">With</a></li>
                        </ul>
                    </div>
                    <br>
                    <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" name="input" method="POST" action="validthreshold2.php">
