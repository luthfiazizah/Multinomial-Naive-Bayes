            ...
            <div class="dashboard-ecommerce">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <br>
                        <h3>UJI COBA</h3>
                        <p>Pada penelitian ini uji coba dilakukan dengan menggunakan metode K-fold Cross Validation. Metode ini akan dibagi secara acak menjadi k partisi (D1, D2, ..., Dk) dan setiap D memiliki jumlah yang sama. Uji coba akan dilakukan sebanyak k kali. Pada penelitian ini menggunakan k = 5 dan k = 10.</p>
                        <div class="row">
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">k = 5</h3>
                                        <p class="card-text">Setiap fold memiliki 26 data</p>
                                        <a href="ujicoba/k5.php" class="btn btn-primary">Uji Coba</a>
                                    </div>
                                </div>
                            </div>
                            <!--<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-title">k = 10</h3>
                                        <p class="card-text">Setiap fold memiliki 13 data</p>
                                        <a href="ujicoba10/k10.php" class="btn btn-primary">Uji Coba</a>
                                    </div>
                                </div>
                            </div>-->
                            </div>
