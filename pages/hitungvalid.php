                    ...
                    <br>
                                ...
                                function LShumor($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][2] = round(($a + $b + 1)/(WIdf($tabel) + Whumor($tabel)),8);
                                    }
                                    return $table;
                                }
                                ...
                                function LShoror($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][3] = round(($a + $b + 1)/(WIdf($tabel) + Whoror($tabel)),8);
                                    }
                                    return $table;
                                }
                                ...
                                function LSroman($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][4] = round(($a + $b + 1)/(WIdf($tabel) + Wroman($tabel)),8);
                                    }
                                    return $table;
                                }
                                ...
                                function LSmisteri($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][5] = round(($a + $b + 1)/(WIdf($tabel) + Wmisteri($tabel)),8);
                                    }
                                    return $table;
                                }
                                ...
                                function LSspiritual($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][6] = round(($a + $b + 1)/(WIdf($tabel) + Wspiritual($tabel)),8);
                                    }
                                    return $table;
                                }
                                ...
                                <div class="tab-content" id="myTabContent7">
                                    <div class="tab-pane fade show active" id="home-justify" role="tabpanel" aria-labelledby="home-tab-justify">
                                        ...
                                        echo "<br>Prior Probabilitas P(humor) = " . round(50/250,3);
                                        echo "<br>Prior Probabilitas P(horor) = " . round(50/250,3);
                                        echo "<br>Prior Probabilitas P(roman) = " . round(50/250,3);
                                        echo "<br>Prior Probabilitas P(misteri) = " . round(50/250,3);
                                        echo "<br>Prior Probabilitas P(spiritual) = " . round(50/250,3);
                                        ...
                                        $humor = Phumor($table)*(50/250);
                                        $horor = Phoror($table)*(50/250);
                                        $roman = Proman($table)*(50/250);
                                        $misteri = Pmisteri($table)*(50/250);
                                        $spiritual = Pspiritual($table)*(50/250);
