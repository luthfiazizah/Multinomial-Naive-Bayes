        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="k51.php">Percobaan 1</a></li>
                                  <li><a class="dropdown-item" href="k512.php">Percobaan 2</a></li>
                                  <li><a class="dropdown-item" href="k514.php">Percobaan 3</a></li>
                                  <li><a class="dropdown-item" href="k516.php">Percobaan 4</a></li>
                                  <li><a class="dropdown-item" href="k518.php">Percobaan 5</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Uji Coba K = 5 Without DF Thresholding Percobaan ke-5</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" name="input" method="POST" action="k519.php">
