            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <br>
                                ...
                                $data = mysqli_query($conn,"SELECT * FROM data_cerita WHERE id_cerita NOT IN (11,12,13,14,15,37,38,39,40,41,63,64,65,66,67,68,90,91,92,93,94,116,117,118,119,120)");
                                ...
                                <div class="tab-content" id="myTabContent7">
                                    ...
                                    <div class="tab-pane fade" id="about-justify" role="tabpanel" aria-labelledby="profile-tab-justify">
                                        ...
                                        echo "<br>Prior Probabilitas P(roman) = " . round(20/104,3);
