        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="k51.php">Without</a></li>
                                  <li><a class="dropdown-item" href="k52.php">With</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Uji Coba K = 5</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" name="input" method="POST" action="k511.php">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                <!--<input type="text" name="inputan" id="" autofocus size='1000' class="textarea">-->
                                            </div>
                                        </div>
                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                <!--<a href="#" class="btn btn-space btn-primary" role="button">with DF Thresholding</a>-->
                                                <!--<a href="k511.php" class="btn btn-space btn-primary" role="button">without DF Thresholding</a>-->
