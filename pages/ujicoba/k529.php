                    ...
                    <br>
                                ...
                                function LShumor($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][2] = round(($a + 1)/(WIdf($tabel) + Whumor($tabel)),5);
                                    }
                                    return $table;
                                }
                                ...
                                function LShoror($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][3] = round(($a + 1)/(WIdf($tabel) + Whoror($tabel)),5);
                                    }
                                    return $table;
                                }
                                ...
                                function LSroman($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][4] = round(($a + 1)/(WIdf($tabel) + Wroman($tabel)),5);
                                    }
                                    return $table;
                                }
                                ...
                                function LSmisteri($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][5] = round(($a + 1)/(WIdf($tabel) + Wmisteri($tabel)),5);
                                    }
                                    return $table;
                                }
                                ...
                                function LSspiritual($table,$tabel){
                                    ...
                                    for ($i=1;$i<sizeof($table);$i++){
                                        ...
                                        $table[$i][6] = round(($a + 1)/(WIdf($tabel) + Wspiritual($tabel)),5);
                                    }
                                    return $table;
                                }
                                ...
                                $data = mysqli_query($conn,"SELECT * FROM data_cerita WHERE id_cerita NOT IN (21,22,23,24,25,26,48,49,50,51,52,74,75,76,77,78,100,101,102,103,104,126,127,128,129,130)");
                                ...
                                <div class="tab-content" id="myTabContent7">
                                    ...
                                    <div class="tab-pane fade" id="about-justify" role="tabpanel" aria-labelledby="profile-tab-justify">
                                        ...
                                        echo "<br>Prior Probabilitas P(humor) = " . round(20/104,3);
                                        echo "<br>Prior Probabilitas P(horor) = " . round(21/104,3);
                                        echo "<br>Prior Probabilitas P(roman) = " . round(21/104,3);
                                        echo "<br>Prior Probabilitas P(misteri) = " . round(21/104,3);
                                        echo "<br>Prior Probabilitas P(spiritual) = " . round(21/104,3);
                                        ...
                                        $humor = Phumor($table)*(20/104);
                                        $horor = Phoror($table)*(21/104);
                                        $roman = Proman($table)*(21/104);
                                        $misteri = Pmisteri($table)*(21/104);
                                        $spiritual = Pspiritual($table)*(21/104);
