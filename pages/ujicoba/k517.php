            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <br>
                                ...
                                $data = mysqli_query($conn,"SELECT * FROM data_cerita WHERE id_cerita NOT IN (16,17,18,19,20,42,43,44,45,46,47,69,70,71,72,73,95,96,97,98,99,121,122,123,124,125)");
                                ...
                                <div class="tab-content" id="myTabContent7">
                                    ...
                                    <div class="tab-pane fade" id="about-justify" role="tabpanel" aria-labelledby="profile-tab-justify">
                                        ...
                                        echo "<br>Prior Probabilitas P(humor) = " . round(21/104,3);
                                        echo "<br>Prior Probabilitas P(horor) = " . round(20/104,3);
                                        ...
                                        $humor = Phumor($table)*(21/104);
                                        $horor = Phoror($table)*(20/104);
