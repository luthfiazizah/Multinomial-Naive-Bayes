        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  <li><a class="dropdown-item" href="k52.php">Percobaan 1</a></li>
                                  <li><a class="dropdown-item" href="k522.php">Percobaan 2</a></li>
                                  <li><a class="dropdown-item" href="k524.php">Percobaan 3</a></li>
                                  <li><a class="dropdown-item" href="k526.php">Percobaan 4</a></li>
                                  <li><a class="dropdown-item" href="k528.php">Percobaan 5</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Uji Coba K = 5 With DF Thresholding Percobaan ke-3</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" name="input" method="POST" action="k525.php">
