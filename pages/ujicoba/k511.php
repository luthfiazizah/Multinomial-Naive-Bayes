            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <br>
                                ...
                                $data = mysqli_query($conn,"SELECT * FROM data_cerita WHERE id_cerita NOT IN (1,2,3,4,5,27,28,29,30,31,53,54,55,56,57,79,80,81,82,83,105,106,107,108,109,110)");
                                ...
                                <div class="tab-content" id="myTabContent7">
                                    ...
                                    <div class="tab-pane fade" id="about-justify" role="tabpanel" aria-labelledby="profile-tab-justify">
                                        ...
                                        echo "<br>Prior Probabilitas P(spiritual) = " . round(20/104,3);
                                        ...
                                        $spiritual = Pspiritual($table)*(20/104);
