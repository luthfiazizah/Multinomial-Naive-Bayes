    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.php">Validasi</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="validasi.php"><i class="fas fa-fw fa-chart-pie"></i>Validasi</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">DF Thresholding</button>
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="validasi.php">Without DF Thresholding</a></li>
                          <li><a class="dropdown-item" href="validasithreshold.php">DF Thresholding 2-37</a></li>
                          <li><a class="dropdown-item" href="validasithreshold1.php">DF Thresholding 2-15</a></li>
                        </ul>
                    </div>
                    <br>
                    <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Form Validasi</h5>
                                <div class="card-body">
                                    <form id="validationform" data-parsley-validate="" novalidate="" name="input" method="POST" action="validthreshold1.php">
